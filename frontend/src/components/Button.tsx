...
const VARIANT_CLASSES: Record<Variant, string> = {
  ...
  primary:
    'inline-flex items-center justify-center gap-2 rounded-full bg-white text-black px-6 py-3.5 min-h-[44px] text-sm font-medium ' +
  ...
  secondary:
    'inline-flex items-center justify-center gap-2 rounded-full border border-[color:var(--arva-border-strong)] bg-transparent text-[color:var(--arva-text)] px-6 py-3.5 min-h-[44px] text-sm font-medium ' +
  ...
  utility:
    'inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-btn border border-[color:var(--arva-border-strong)] bg-transparent text-[color:var(--arva-text)] px-3.5 py-2 min-h-[44px] text-xs font-medium ' +
    'transition-colors duration-200 hover:border-[color:var(--arva-gold-muted)] active:bg-white/5 ' +
    'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--arva-gold)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--arva-bg)] ' +
    'disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:border-[color:var(--arva-border-strong)]',
};
